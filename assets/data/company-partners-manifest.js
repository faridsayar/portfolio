// NOTE: Partner logos for partner-logos-section — edit assets/data/company-partners.json and run pnpm generate:company-partners-manifest.
window.__COMPANY_PARTNERS_MANIFEST = {
  "logoHeight": 72,
  "partners": [
    {
      "name": "Yanmee",
