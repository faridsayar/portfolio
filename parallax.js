...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // NOTE: This file was written for the previous hero layout.
  // If those elements are not present (new redesign), safely do nothing.
  if (!nameTitle || !mainTitle || !seoText || !awardImage) return;
  ...
  function updateScrollAnimations() {
    ...
    // 1. Ascens ANS - fly up to top and stick as logo
