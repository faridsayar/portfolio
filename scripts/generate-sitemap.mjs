...
<!-- NOTE: XML sitemap for Google/Bing: one entry per public route only. Project URLs use
     /prosjekter/{slug}. Innsikt hub + articles use /innsikt/{slug}. /application-form is the
     design-samtale kontaktform. Includes /en/* intent landings. /gallery is retired (301 → home).
     Static assets are intentionally excluded. Generated by scripts/generate-sitemap.mjs -->
